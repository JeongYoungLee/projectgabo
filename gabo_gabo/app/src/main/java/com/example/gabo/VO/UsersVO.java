...
public class UsersVO implements Serializable {
    ...
    public UsersVO(String users_id, String users_pw, String users_name, Date users_birth, String users_phone,
                   String users_email, String users_gender, String users_nick) {
    ...
    public Date getUsers_birth() {
        return users_birth;
    }

    public void setUsers_birth(Date users_birth) {
        this.users_birth = users_birth;
    }
